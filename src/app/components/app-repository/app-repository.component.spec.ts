...
describe('Repository Component', () => {
  ...
  beforeEach(async(() => {
    fixture = TestBed.configureTestingModule({
      imports: [NgUploaderModule, FormsModule, RouterTestingModule, HttpModule, HttpClientModule],
  ...
  describe('Repository Component', () => {
    ...
    beforeEach(inject([HttpClient, Router, XHRBackend], (http: HttpClient, router: Router, be: MockBackend) => {
      ...
      const optionsBuilds = new ResponseOptions({ status: 200, body: { data: fakeBuilds } });
      responseBuilds = new Response(optionsBuilds);
      const optionsRepo = new ResponseOptions({ status: 200, body: { data: fakeRepository } });
      responseRepo = new Response(optionsRepo);
      const optionsBadge = new ResponseOptions({ status: 200, body: badge });
