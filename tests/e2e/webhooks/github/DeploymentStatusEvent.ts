export let request = {
  'deployment_status': {
    'url': 'https://api.github.com/repos/baxterthehacker'
            + '/public-repo/deployments/710692/statuses/1115122',
    'id': 1115122,
    'state': 'success',
    'creator': {
  ...
  'deployment': {
    ...
    'statuses_url':
      'https://api.github.com/repos/baxterthehacker/public-repo/deployments/710692/statuses',
    'repository_url': 'https://api.github.com/repos/baxterthehacker/public-repo'
  },
  'repository': {
    'id': 35129377,
