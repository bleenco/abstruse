export let request = {
  ...
  'milestone': {
    ...
    'html_url': 'https://github.com/baxterandthehackers/public-repo/milestones'
              + '/Test%20milestone%20creation%20webhook%20from%20command%20line2',
    'labels_url':
      'https://api.github.com/repos/baxterandthehackers/public-repo/milestones/3/labels',
    'id': 2055681,
    'number': 3,
  ...
  'repository': {
    ...
    'collaborators_url': 'https://api.github.com/repos/baxterandthehackers'
                      + '/public-repo/collaborators{/collaborator}',
    ...
    'issue_events_url':
      'https://api.github.com/repos/baxterandthehackers/public-repo/issues/events{/number}',
    'events_url': 'https://api.github.com/repos/baxterandthehackers/public-repo/events',
    'assignees_url':
      'https://api.github.com/repos/baxterandthehackers/public-repo/assignees{/user}',
    'branches_url':
      'https://api.github.com/repos/baxterandthehackers/public-repo/branches{/branch}',
    ...
    'git_commits_url':
      'https://api.github.com/repos/baxterandthehackers/public-repo/git/commits{/sha}',
    'comments_url':
      'https://api.github.com/repos/baxterandthehackers/public-repo/comments{/number}',
    'issue_comment_url':
      'https://api.github.com/repos/baxterandthehackers/public-repo/issues/comments{/number}',
    'contents_url': 'https://api.github.com/repos/baxterandthehackers/public-repo/contents/{+path}',
    'compare_url':
      'https://api.github.com/repos/baxterandthehackers/public-repo/compare/{base}...{head}',
    'merges_url': 'https://api.github.com/repos/baxterandthehackers/public-repo/merges',
    'archive_url':
      'https://api.github.com/repos/baxterandthehackers/public-repo/{archive_format}{/ref}',
    ...
    'milestones_url':
      'https://api.github.com/repos/baxterandthehackers/public-repo/milestones{/number}',
    'notifications_url': 'https://api.github.com/repos/'
                        + 'baxterandthehackers/public-repo/notifications{?since,all,participating}',
