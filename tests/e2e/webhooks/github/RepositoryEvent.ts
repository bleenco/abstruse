export let request = {
  ...
  'repository': {
    ...
    'collaborators_url': 'https://api.github.com/repos/'
                          + 'baxterandthehackers/new-repository/collaborators{/collaborator}',
    ...
    'issue_events_url':
      'https://api.github.com/repos/baxterandthehackers/new-repository/issues/events{/number}',
    'events_url': 'https://api.github.com/repos/baxterandthehackers/new-repository/events',
    'assignees_url':
      'https://api.github.com/repos/baxterandthehackers/new-repository/assignees{/user}',
    'branches_url':
      'https://api.github.com/repos/baxterandthehackers/new-repository/branches{/branch}',
    ...
    'git_tags_url':
      'https://api.github.com/repos/baxterandthehackers/new-repository/git/tags{/sha}',
    'git_refs_url':
      'https://api.github.com/repos/baxterandthehackers/new-repository/git/refs{/sha}',
    'trees_url': 'https://api.github.com/repos/baxterandthehackers/new-repository/git/trees{/sha}',
    'statuses_url':
      'https://api.github.com/repos/baxterandthehackers/new-repository/statuses/{sha}',
    ...
    'contributors_url':
      'https://api.github.com/repos/baxterandthehackers/new-repository/contributors',
    'subscribers_url':
      'https://api.github.com/repos/baxterandthehackers/new-repository/subscribers',
    'subscription_url':
      'https://api.github.com/repos/baxterandthehackers/new-repository/subscription',
    'commits_url': 'https://api.github.com/repos/baxterandthehackers/new-repository/commits{/sha}',
    'git_commits_url':
      'https://api.github.com/repos/baxterandthehackers/new-repository/git/commits{/sha}',
    'comments_url':
      'https://api.github.com/repos/baxterandthehackers/new-repository/comments{/number}',
    'issue_comment_url':
      'https://api.github.com/repos/baxterandthehackers/new-repository/issues/comments/{number}',
    'contents_url':
      'https://api.github.com/repos/baxterandthehackers/new-repository/contents/{+path}',
    'compare_url':
      'https://api.github.com/repos/baxterandthehackers/new-repository/compare/{base}...{head}',
    'merges_url': 'https://api.github.com/repos/baxterandthehackers/new-repository/merges',
    'archive_url':
      'https://api.github.com/repos/baxterandthehackers/new-repository/{archive_format}{/ref}',
    ...
    'milestones_url':
      'https://api.github.com/repos/baxterandthehackers/new-repository/milestones{/number}',
    'notifications_url': 'https://api.github.com/repos/baxterandthehackers'
                         + '/new-repository/notifications{?since,all,participating}',
